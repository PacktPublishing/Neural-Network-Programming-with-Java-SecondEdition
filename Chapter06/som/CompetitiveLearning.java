...
/**
 * This class implements the competitive learning algorithm.
 * 
...
public class CompetitiveLearning extends LearningAlgorithm {
    ...
    public void test() throws NeuralException{
        if(neuralNet.getNumberOfHiddenLayers()>0){
        	...
        	indexWinnerNeuronTest = new int[testingDataSet.numberOfRecords];
    ...
    public void showPlot2DData(){
        ...
        String[] seriesNames = {"Training Data01", "Training Data02", "Training Data03", "Training Data04", "Training Data05", "Training Data06", "Training Data07", "Training Data08", "Training Data09", "Training Data10"};
        Paint[] seriesColor  = {Color.WHITE, Color.BLACK, Color.BLUE, Color.RED, Color.PINK, Color.CYAN, Color.MAGENTA, Color.YELLOW, Color.GRAY, Color.ORANGE};
	...
	public int[] getIndexWinnerNeuronTrain() {
		return indexWinnerNeuronTrain;
	}

	public void setIndexWinnerNeuronTrain(int[] indexWinnerNeuronTrain) {
		this.indexWinnerNeuronTrain = indexWinnerNeuronTrain;
	}

	public int[] getIndexWinnerNeuronTest() {
		return indexWinnerNeuronTest;
	}

	public void setIndexWinnerNeuronTest(int[] indexWinnerNeuronTest) {
		this.indexWinnerNeuronTest = indexWinnerNeuronTest;
	}
